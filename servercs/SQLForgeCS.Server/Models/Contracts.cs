...
public sealed record DbOkRowCountResponse(bool Ok, int RowCount, string? Error = null);
...
public sealed record DbDescribeTableRequest(string FullName);

public sealed record DbPrimaryKeyRequest(string FullName);
